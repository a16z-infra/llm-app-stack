...
| Name (site) | Description | Github | Pip Installs |
|------------|------------|------------|------------|
| [UpTrain AI](https://uptrain.ai/) | Full-stack LLMops platform for all your production needs from Evaluation to Experimentation to Improvement | <a href="https://github.com/uptrain-ai/uptrain"><img src="https://img.shields.io/github/stars/uptrain-ai/uptrain?style=social" width=90/></a> | <a href=https://pypi.org/project/uptrain><img src="https://img.shields.io/pypi/dw/uptrain" width=150/></a> |
