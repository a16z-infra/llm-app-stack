...
| Name (site) | Description | Github | Pip Installs |
|------------|------------|------------|------------|
| [Agenta](https://agenta.ai) | An open-source LLM developer platform with prompt management, evaluation, human feedback, and deployment all in one place. |  <a href=https://github.com/agenta-ai/agenta><img src="https://img.shields.io/github/stars/agenta-ai/agenta?style=social" width=90/></a> | <a href=https://pypi.org/project/agenta><img src="https://img.shields.io/pypi/dw/agenta" width=150/></a> |
