...
| Name (site) | Description | Github | Pip Installs |
|------------|------------|------------|------------|
| [Galileo](https://www.rungalileo.io/) | Galileo is a unified platform for rapid evaluation, fine-tuning and real-time observability, powered by high-accuracy hallucination guardrails. Built for teams building enterprise-grade GenAI powered applications. | N/A | N/A |
